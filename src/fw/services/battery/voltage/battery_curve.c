...
#if defined(CONFIG_BOARD_ASTERIX) || defined(CONFIG_BOARD_BANGLE2) || defined(CONFIG_BOARD_OBELIX) || defined(CONFIG_BOARD_QEMU_EMERY) || defined(CONFIG_BOARD_QEMU_FLINT) || defined(CONFIG_BOARD_QEMU_GABBRO)
